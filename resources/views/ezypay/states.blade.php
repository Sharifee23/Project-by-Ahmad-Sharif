                ...
                "columns": [
                    ...
                    { "data": "name" },
                    {
                        ...
                        "render": function (data, type, row) {
                            ...
                            if (data.can_edit) {
                                actions += '<a href="#" class="btn btn-sm btn-success edit-btn" data-id="'+data.id+'" data-name="'+data.name+'">Edit</a> ';
                            }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status === 200) {
                            ...
                            toastr.success('Error updating State');
                        }
                    }
                });
            });
                ...
                if (confirm('Are you sure you want to delete this employee?')) {
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.status === 200) {
                                $('#myTable').DataTable().ajax.reload();
                                toastr.warning('State deleted successfully'); 
                            } else {
                        ...
                        error: function(xhr, status, error) {
                            console.error(xhr); 
                            toastr.success('Error deleting State');
                        }
                    });
                }
            });
