                ...
                <div class="row">
                    <div class="col-xl-8">
                        <div>
                            ...
                            <label for="market">Select Main Market:</label>
                            <select id="market" disabled>
                            </select>

                            <label for="compareMarket">Compare with Other Markets:</label>
                            <select id="compareMarket" multiple disabled>
                            </select>
